                  ...
                  return (
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.div
                          layoutId="nav-pill"
                          className="absolute -bottom-2 inset-x-0 h-0.5 bg-primary shadow-[0_0_10px_rgba(0,230,118,0.8)]"
                        />
                      )}
                    </Link>
                  )
          ...
          <div className="hidden md:flex items-center gap-4">
            {isAuthenticated ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <Link to="/signup" className="text-sm font-medium bg-primary text-black px-5 py-2 rounded-full hover:shadow-[0_0_15px_rgba(0,230,118,0.4)] transition-all">
                  Get Started
                </Link>
              </div>
            )}
